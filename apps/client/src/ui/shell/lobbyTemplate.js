  ...
  return `
    <section id="online-lobby" class="online-lobby" aria-labelledby="lobby-title">
      <div class="lobby-panel">
        ...
        <p>Personalize seu baralho e depois crie uma sala privada ou entre usando o código de outro rei.</p>
        ...
        <div class="lobby-actions">
          <button id="open-deck-builder" class="deck-menu-button">PERSONALIZAR DECK <small id="deck-status">NÃO MONTADO</small></button>
